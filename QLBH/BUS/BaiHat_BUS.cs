   ...
   public class BaiHat_BUS
    {
       BaiHat_DATA objBaiHat = new BaiHat_DATA();
        ...
        {
            return objBaiHat.themBaiHat(mabaihat, tenbaihat, matheloai, maalbum, macasi, matacgia, mahangsanxuat, loibaihatt);
        }
        ...
        {
            return objBaiHat.capnhatBaiHat(mabaihat, tenbaihat, matheloai, maalbum, macasi, matacgia, mahangsanxuat, loibaihatt);
        }
